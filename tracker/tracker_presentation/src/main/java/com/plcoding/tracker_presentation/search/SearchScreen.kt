...
fun SearchScreen(
    ...
    Column(
        ...
        Text(
            text = stringResource(id = R.string.add_meal, mealName), style = MaterialTheme.typography.h2
        )
        ...
        LazyColumn(modifier = Modifier.fillMaxSize()) {
            items(state.trackableFood) { food ->
                TrackableFoodItem(
                    ...
                    onAmountChange = { viewModel.onEvent(SearchEvent.OnAmountForFoodChange(food.food, it)) },
                    onTrack = {
                        viewModel.onEvent(
