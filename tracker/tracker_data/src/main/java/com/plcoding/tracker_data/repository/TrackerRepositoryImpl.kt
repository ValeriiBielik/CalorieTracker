...
import com.plcoding.tracker_data.local.dao.TrackerDao
...
class TrackerRepositoryImpl(
    ...
    override suspend fun searchFood(query: String, page: Int, pageSize: Int): Result<List<TrackableFood>> {
        return try {
            ...
            // todo in this case we have a small amount of items, think about solution. Also we have a problem of timeouts, i suppose due to api restrictions
