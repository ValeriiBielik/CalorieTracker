        ...
        Column(
            ...
            Row(
                ...
                SelectableButton(
                    ...
                    onCLick = { viewModel.onActivitySelect(ActivityLevel.Low) },
                ...
                SelectableButton(
                    ...
                    color = MaterialTheme.colors.primaryVariant,
                    selectedTextColor = Color.White,
                    onCLick = { viewModel.onActivitySelect(ActivityLevel.Medium) },
                    textStyle = MaterialTheme.typography.button.copy(
                        fontWeight = FontWeight.Normal
                    )
                )
                ...
                SelectableButton(
                    ...
                    color = MaterialTheme.colors.primaryVariant,
                    selectedTextColor = Color.White,
                    onCLick = { viewModel.onActivitySelect(ActivityLevel.High) },
                    textStyle = MaterialTheme.typography.button.copy(
                        fontWeight = FontWeight.Normal
                    )
                )
